...
function dTree(objName) {
	...
	this.icon = {
		...
		root				:(this.config.imageDir!=null)?this.config.imageDir="/"+base.gif: 'image/icon/dtree/img/base.gif',

		folder			: 'image/icon/dtree/img/folder.gif',

		folderOpen	: 'image/icon/dtree/img/folderopen.gif',

		node				: 'image/icon/dtree/img/page.gif',

		empty				: 'image/icon/dtree/img/empty.gif',

		line				: 'image/icon/dtree/img/line.gif',

		join				: 'image/icon/dtree/img/join.gif',

		joinBottom	: 'image/icon/dtree/img/joinbottom.gif',

		plus				: 'image/icon/dtree/img/plus.gif',

		plusBottom	: 'image/icon/dtree/img/plusbottom.gif',

		minus				: 'image/icon/dtree/img/minus.gif',

		minusBottom	: 'image/icon/dtree/img/minusbottom.gif',

		nlPlus			: 'image/icon/dtree/img/nolines_plus.gif',

		nlMinus			: 'image/icon/dtree/img/nolines_minus.gif',
		iconUnCheckAll : 'image/icon/dtree/img/iconUnCheckAll.gif',
		iconCheckAll :'image/icon/dtree/img/iconCheckAll.gif',
		iconCheckGray : 'image/icon/dtree/img/iconCheckGray.gif'
    ...
    if(node.nodeActionList){
        ...
        for(i=0;i<node.nodeActionList.size();i++){
            ...
            if(nodeActionObj.actionUrl.indexOf("javascript:")==-1){
				...
				str+='<a href="javascript:"' +nodeActionObj.actionUrl+ '" ';
			}
            str+=' >';
