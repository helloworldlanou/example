  ...
  <tr>
   ...
   <c:if test="${havechild=='no'}">
     <tr>
       ...
       <a class="styleWhite" style="cursor:pointer"  onclick="DoMenu('${mainnode.id}')" ><c:out value = "${mainnode.name}" /></a></span>
       </td>
     </tr>
     </c:if>
      ...
      <td width="160" bgcolor="#FFFFFF">
          ...
          <c:if test="${node.parentId==mainnode.id}" var="have">
          	 <tr >
                ...
                <A class=g12  href="mainAction.do?action=toSecondaryPage&pnid=<c:out value = '${mainnode.id}' />&nid=<c:out value = '${node.id}' />" >&nbsp;<c:out value="${node.name}" /></A>
                </c:if>
                <c:if test="${node.type=='custom'}">
                <A class=g12  href="mainAction.do?action=toFacilityPage&pnid=<c:out value = '${mainnode.id}' />&nid=<c:out value = '${node.id}' />&q1=${node.boFacilityType.id}" >&nbsp;<c:out value="${node.name}" /></A>
                </c:if>
                </td>
             </tr>
             <tr>
          ...
          <c:if test="${havechild=='no'}">
           <tr >
                <td align=right ><IMG height=9  src="image/main/arrow_021.gif" width=12></td>
                <td height=20><A class=g12 href="mainAction.do?action=toSecondaryPage&pnid=<c:out value = '${mainnode.id}' />&nid=-2" >&nbsp;<c:out value="${mainnode.name}" /></A></td>
             </tr>
             <tr>
                 <td colSpan=2><IMG height=2  width="160"  src="image/main/line01.gif" ></td>
             </tr>
                ...
                <tr>
                         		 ...
                         		 <table width="99%" height="151"    border=0 cellPadding=0 cellSpacing=4> 
                             	 		<tr>
                              			 ...
                              			 <c:if test="${top.newsNameSet!='bigup'}">
                                			<td align=middle><B  style="FONT-SIZE: 16px; COLOR: #9c0000"><c:if test="${top.id==null}">暂时没有头条新闻</c:if>${top.newsName}</B>
                                			<br>
                                			...
                                			<br>
                                			<B  style="FONT-SIZE: 16px; COLOR: #9c0000"><c:if test="${top.id==null}">暂时没有头条新闻</c:if>${top.newsName}</B>
                                			</td>
											</c:if>
                               			 </tr>
                  ...
                  <c:choose>
                 	 <c:when test="${ contentlength < 160 }" >
                 		 <a class=black12 href="mainAction.do?action=toDetailPage&newsid=${top.id}" target="_blank"><c:out value="${topContent}" /></a>
                  	 </c:when>
                  	 <c:otherwise>
                  		<c:set var="subname" value='${fn:substring(topContent,0,159)}'/>
                   	 <a class=black12 href="mainAction.do?action=toDetailPage&newsid=${top.id}" target="_blank"><c:out value="${subname}" />...</a>
                  	 </c:otherwise>
                  </c:choose></td>
                             			 </tr>
                             	</table>                            	</td>
  ...
  <tr>
    <td width="387" valign="top">
     ...
     <table cellSpacing=0 cellPadding=0 width=384 border=0> 
              <tr >
              	 <td background="image/main/1-3.gif" height="30"  align="left"><span  style="padding-left:60px"><a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=4a4cc0c91f6d690d011f6d6f773b0003&nid=4a4cc0ef1fff14f7011fff2a542d0003">中心新闻</a></span><span   style="padding-left:180px">	  <a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=4a4cc0c91f6d690d011f6d6f773b0003&nid=4a4cc0ef1fff14f7011fff2a542d0003" >
	  更多>>
	  </a></span> </td>
              </tr>
              <tr>
      ...
      <c:forEach items="${centernews}" var="centernews" varStatus="number">
        <c:if test="${number.count<=10 }" >
         <tr>
                ...
                <td class=black12 width="71%" height=17><div align="left"><A class=black12  href="mainAction.do?action=toDetailPage&newsid=${centernews.id}" 
                  target=_blank>
                  ...
                  <c:choose>
                 	 <c:when test="${ namelength < 20 }" >
                  	 ...
                  	 <c:otherwise>
                  		<c:set var="subname" value='${fn:substring(centernews.newsName,0,17)}'/>
                   	 <c:out value="${subname}" />……
                  	 </c:otherwise>
                  </c:choose>
                ...
                <td class=black12 width="25%">(<fmt:formatDate type="date" value="${centernews.newsTime}" pattern="yyyy-MM-dd"/>)</td>
        </tr>
        </c:if>
      </c:forEach>
      <tr>
...
>培训动态</A></span></td>
     ...
     <table width="384" border=0 cellPadding=0 cellSpacing=2> 
        ...
        <c:if test="${number.count<=10 }" >
         <tr>
                <td class=black12 align=middle width="4%">·</td>
                <td class=black12 width="71%" height=17><div align="left"><A class=black12  href="mainAction.do?action=toDetailPage&newsid=${trainingnews.id}" 
                  target=_blank>
                  ...
                  <c:choose>
                 	 <c:when test="${ namelength < 20 }" >
                  	 ...
                  	 <c:otherwise>
                  		<c:set var="subname" value='${fn:substring(trainingnews.newsName,0,18)}'/>
                   	 <c:out value="${subname}" />……
                  	 </c:otherwise>
                  </c:choose>
                ...
                <td class=black12 width="25%">(<fmt:formatDate type="date" value="${trainingnews.newsTime}" pattern="yyyy-MM-dd"/>)</td>
        </tr>
        </c:if>
      </c:forEach>
    </table>    
     ...
     <table cellSpacing=0 cellPadding=0 width=384 border=0> 
              <tr>
              	 <td background="image/main/1-3.gif" height="30"  align="left"><span  style="padding-left:60px"><a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=4a4cc0c91f6d690d011f6d7007370006&nid=8a81fa2220a36ab50120a37984b10002">成功案例</a></span><span   style="padding-left:180px">	  <a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=4a4cc0c91f6d690d011f6d7007370006&nid=8a81fa2220a36ab50120a37984b10002" >
	  更多>>
	  </a></span> </td>
              </tr>
              <tr>
     ...
     <table width="384" border=0 cellPadding=0 cellSpacing=2> 
        ...
        <c:if test="${number.count<=10 }" >
         <tr>
                <td class=black12 align=middle width="4%">·</td>
                <td class=black12 width="71%" height=17><div align="left"><A class=black12  href="mainAction.do?action=toDetailPage&newsid=${projectnews.id}" 
                  target=_blank>
                  ...
                  <c:choose>
                 	 <c:when test="${ namelength < 20 }" >
                  	 ...
                  	 <c:otherwise>
                  		<c:set var="subname" value='${fn:substring(projectnews.newsName,0,17)}'/>
                   	 <c:out value="${subname}" />……
                  	 </c:otherwise>
                  </c:choose>
                ...
                <td class=black12 width="25%">(<fmt:formatDate type="date" value="${projectnews.newsTime}" pattern="yyyy-MM-dd"/>)</td>
        </tr>
        </c:if>
      </c:forEach>
	   <tr>
...
<c:forEach items="${centerMap}" var="map">
     <table cellSpacing=0 cellPadding=0 width=384 border=0> 
              <tr>
              	 <td background="image/main/1-3.gif" width="184" height="30"><span style="padding-left:60px"><a href="mainAction.do?action=toSecondaryPage" class="styleWhite">${map.key.name}</a></span></td>
              </tr>
              <tr>
                <td height=8></td>
              </tr>
     ...
     <table width="384" border=0 cellPadding=0 cellSpacing=2> 
         ...
         <tr>
                <td class=black12 align=middle width="4%">·</td>
                <td class=black12 width="71%" height=17><A class=black12  href="mainAction.do?action=toDetailPage&newsid=${n.id}" 
                  target=_blank>
		</td>
                <td class=black12 width="25%">( <fmt:formatDate type="date" value="${n.newsTime}" pattern="yyyy-MM-dd"/> )</td>
        </tr>
   ...
   <Table width=180 border=0 align="center" cellPadding=0 cellSpacing=2> 
                ...
                <td align=middle >
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td width="142"  align="left" ><a href="mainAction.do?action=toSpecialSecondaryPage&specialid=<c:out value='${spe.id}' />" class=g13>${spe.name }</a></td>
                    </tr>
                    <tr>
     ...
     <c:forEach items="${linksSort}" var="lsort">
     <Table width="176" border=0 align="center" cellPadding=0 cellSpacing=0  >              
              <tr>
                <td width="176" height="25" align="center" background="image/main/mainright_top1.gif" style="background-repeat:no-repeat" class="red14b STYLE47">${lsort.sortname}</td>
              </tr>  
			  <tr height="20"></tr>                   
              <tr>
                <td align=middle>
                <select class=black12 
                  ...
                  name=select3> 
                   <option selected value="" >${lsort.sortname} </option>
                   <c:forEach items="${links}" var="link">
                   <c:if test="${link.boLinksSort.id==lsort.id}"><option value="${link.url}">${link.name }</option></c:if>
                   </c:forEach>
                   </td></tr>
				     <tr height="10"></tr> 
