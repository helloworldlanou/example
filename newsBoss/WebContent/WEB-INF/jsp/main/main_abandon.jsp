...
function DoMenu(emid,eimg)
{
var obj = document.getElementById(emid);
var oobj = document.getElementById(eimg);
...
LastLeftID = emid;
   for(i=1;i<4;i++){
document.getElementById("img"+i).src="dh+.gif";//改变大类前面的'+' '-'号
}
...
// if((Lastimg!="")&&(eimg!= Lastimg)) 
//{

// document.getElementById(Lastimg).src = "dh+.gif";
// }
// Lastimg = eimg;
}
function GetMenuID()
  ...
  <tr>
   ...
   <c:if test="${havechild=='no'}">
     <tr>
       ...
       <a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=<c:out value = '${mainnode.id}' />&nid=-2"><c:out value = "${mainnode.name}" /></a></span>
       </td>
     </tr>
     </c:if>
...
<span style="padding-left:35px">
       <a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=<c:out value = '${mainnode.id}' />&nid=-1"><c:out value = "${mainnode.name}" /></a></span>
       </c:if>
       <c:if test="${mainnode.type=='custom'}">
<span style="padding-left:35px">
       <a class="styleWhite" href="mainAction.do?action=toFacilityPage&pnid=<c:out value = '${mainnode.id}' />&nid=-1"><c:out value = "${mainnode.name}" /></a></span>
       </c:if>
                        	...
                        	<tr>
                         		 ...
                         		 <table width="99%" height="151"    border=0 cellPadding=0 cellSpacing=4> 
                             	 		<tr>
                              			 ...
                              			 <tr>
                                			<td align=middle><B  style="FONT-SIZE: 16px; COLOR: #9c0000"><c:if test="${top.id==null}">暂时没有头条新闻</c:if>${top.newsName}</B></td>
                               			 </tr>
  ...
  <tr>
    <td width="387" valign="top">
     ...
     <table cellSpacing=0 cellPadding=0 width=384 border=0> 
              <tr >
              	 <td background="image/main/1-3.gif" height="30"  align="left"><span  style="padding-left:60px"><a class="styleWhite" href="mainAction.do?action=toSecondaryPage&pnid=4a4cc0c91f6d690d011f6d6f773b0003&nid=4a4cc0ef1fff14f7011fff2a542d0003">中心新闻</a></span> </td>
              </tr>
              <tr>
                <td height=8></td>
              </tr>
...
<c:forEach items="${centerMap}" var="map">
   ...
   <Table width=180 border=0 align="center" cellPadding=0 cellSpacing=2> 
     ...
     <Table width="170" border=0 align="center" cellPadding=0 cellSpacing=0  >              
              <tr>
                <td width="170" height="25" align="center" background="image/main/mainright_top1.gif" style="background-repeat:no-repeat" class="red14b STYLE47">${lsort.sortname}</td>
              </tr>  
			  <tr height="20"></tr>                   
              <tr>
                <td align=middle>
