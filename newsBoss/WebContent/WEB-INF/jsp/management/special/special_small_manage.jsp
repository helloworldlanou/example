...
<link href="css/text.css" rel="stylesheet" type="text/css" />
	...
	<form name="form1" method="post"
			><table width="60%" border="0" cellspacing="0" cellpadding="0"><tr><td width="430" height="7"></td><td rowspan="4" align="center"></td></tr><tr><td width="430" height="25" class="title14">小类管理 &gt;&gt;<br>
		...
		<table width="95%" border="0" cellspacing="1" bgcolor="#CCCCCC">
			<tr align="center" height="30" class="text14wb">
				...
				<td background="image/bg/table_head.gif">英文名称</td>
					<td background="image/bg/table_head.gif">专题名称</td>
			...
			<c:forEach var="n" items="${list}" varStatus="i">
				...
				<tr align="center" bgcolor="#FFFFFF" class="text12">
					...
					<td><c:out value="${n.prename}"></c:out></td>
					<td>
						<fmt:formatDate value="${n.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>						</td>
					<td>
						<a href="specialAction.do?action=toModifySmallSpecialPage&id=${n.id}"><font
								color="#33CCFF">修改</font>							</a>
							
						<a href="specialAction.do?action=deleteSmall&id=${n.id}&vote=s"
		  ...
		  <table>
			<tr>
                  ...
                  <td align="center">　　
                  <a href="specialAction.do?action=toSpecialManagePage" ><img src="image/botton/special_manage.gif"  width="102" height="29" border="0"></a>
                  </td>
                  <c:if test='${!isnull}'>
               <td align="center">　　
